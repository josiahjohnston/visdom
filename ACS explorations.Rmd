...
# This calling style works with census tracts, but not zip codes.
...
# It has trouble with all of the CA zip codes at once..
...
# Now try with a variable that we care about
...
I also notice that "Data Profile" data is only available from 2012 onwards. 

API calls: 
http://api.census.gov/data/2012/acs5/profile?get=DP02_0001PE&for=state:*&key=
http://api.census.gov/data/2014/acs5/profile?get=DP02_0001PE,NAME&for=zip+code+tabulation+area:89010&key=b9cfb06fa75169602cd01ece4bef67ae71654b93

http://api.census.gov/data/2014/acs5/profile?get=DP02_0001PE,NAME&for=zip+code+tabulation+area:94709&key=b9cfb06fa75169602cd01ece4bef67ae71654b93

http://api.census.gov/data/2014/acs5/profile?get=DP02_0001E,DP02_0001M,DP02_0001PE,DP02_0001PM,DP02_0002E,DP02_0002M,DP02_0002PE,DP02_0002PM,DP02_0003E,DP02_0003M,DP02_0003PE,DP02_0003PM,DP02_0004E,DP02_0004M,DP02_0004PE,DP02_0004PM,DP02_0005E,DP02_0005M,DP02_0005PE,DP02_0005PM,DP02_0006E,DP02_0006M,DP02_0006PE,DP02_0006PM,DP02_0007E,DP02_0007M,DP02_0007PE,DP02_0007PM,DP02_0008E,DP02_0008M,DP02_0008PE,DP02_0008PM,DP02_0009E,DP02_0009M,DP02_0009PE,DP02_0009PM,DP02_0010E,DP02_0010M,NAME&for=zip+code+tabulation+area:96161&key=b9cfb06fa75169602cd01ece4bef67ae71654b93


```{r}
results2 = acs.fetch(
     endyear=2014, span = 5,
     geography=geo.make(zip.code=96161), 
     variable=c('DP02_0001'), 
     dataset = "acs_dp")
```